...
This is a Kubernetes operator for Developer Portal APIs and Controllers, built using the Kubebuilder framework (v4) and operator-sdk v1.41.1. The project manages Developer Portal resources in Kubernetes clusters.
